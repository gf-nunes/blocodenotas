"""
Django settings for blocodenotas project.
...
ROOT_URLCONF = 'blocodenotas.urls'
...
WSGI_APPLICATION = 'blocodenotas.wsgi.application'
...
LOGGING = {
    ...
    'handlers': {
        ...
        'file': {
            ...
            'filename': os.getenv('DJANGO_LOG_FILE', './blocodenotas.log'),
            'formatter': 'simple'
        },
    },
    'loggers': {
